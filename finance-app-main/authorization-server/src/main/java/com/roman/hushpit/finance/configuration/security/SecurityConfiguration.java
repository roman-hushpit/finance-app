package com.roman.hushpit.finance.configuration.security;
...
import com.roman.hushpit.finance.security.CustomTokenEnhancer;
import com.roman.hushpit.finance.security.CustomUserDetailsService;
...
public class SecurityConfiguration {
    ...
    public UserDetailsService userDetailsService(CustomUserRepository customUserRepository) {
        return new CustomUserDetailsService(customUserRepository);
    }


    @Bean
    public OAuth2TokenCustomizer<JwtEncodingContext> tokenEnhancer() {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        var registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .authorizationGrantTypes(
                        grandTypes -> {
                            grandTypes.add(AuthorizationGrantType.AUTHORIZATION_CODE);
                            grandTypes.add(AuthorizationGrantType.JWT_BEARER);
                            grandTypes.add(AuthorizationGrantType.REFRESH_TOKEN);
